using ReservationSystemLibrary;
using System;
...
namespace ReservationSystemConsole
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            rs.Rules.Add
                (
                (List<Reservation> reservations, Reservation newReservation) =>
                {
            ...
            rs.Rules.Add
                ...
                (List<Reservation> reservations, Reservation newReservation) =>
                {
                    return newReservation.Capacity <= 10;
                }
                );
